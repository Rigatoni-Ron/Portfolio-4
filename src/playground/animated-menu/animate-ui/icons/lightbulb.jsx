...
const animations = {
  default: {
    path1: {
      initial: { rotate: 0, fill: 'transparent' },
      animate: {
        ...
        transition: {
          duration: 0.8,
          ease: 'easeInOut',
          rotate: { duration: 0.8, ease: 'easeInOut', times: [0, 0.4, 0.6, 0.8, 1] },
          fillOpacity: { duration: 0.3, ease: 'easeInOut', times: [0, 0.4, 0.6, 0.8, 1], delay: 0.4 },
        },
      },
    },
    path2: {
      ...
      animate: {
        transformOrigin: 'bottom center',
        rotate: [0, 0, 10, -5, 0],
        transition: { duration: 0.8, ease: 'easeInOut', times: [0, 0.4, 0.6, 0.8, 1] },
      },
    },
    path3: {},
  },
...
export { Lightbulb, Lightbulb as LightbulbIcon }
